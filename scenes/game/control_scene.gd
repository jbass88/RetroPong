...
@onready var check_button_left_player_1: CheckButton = $CenterContainer/VBoxContainer/GridContainer/CheckButtonLeftPlayer1
@onready var check_button_left_player_2: CheckButton = $CenterContainer/VBoxContainer/GridContainer/CheckButtonLeftPlayer2
@onready var check_button_left_ai_easy: CheckButton = $CenterContainer/VBoxContainer/GridContainer/CheckButtonLeftAiEasy
@onready var check_button_left_ai_medium: CheckButton = $CenterContainer/VBoxContainer/GridContainer/CheckButtonLeftAiMedium
@onready var check_button_left_ai_hard: CheckButton = $CenterContainer/VBoxContainer/GridContainer/CheckButtonLeftAiHard
@onready var check_button_right_player_1: CheckButton = $CenterContainer/VBoxContainer/GridContainer/CheckButtonRightPlayer1
@onready var check_button_right_player_2: CheckButton = $CenterContainer/VBoxContainer/GridContainer/CheckButtonRightPlayer2
@onready var check_button_right_ai_easy: CheckButton = $CenterContainer/VBoxContainer/GridContainer/CheckButtonRightAiEasy
@onready var check_button_right_ai_medium: CheckButton = $CenterContainer/VBoxContainer/GridContainer/CheckButtonRightAiMedium
@onready var check_button_right_ai_hard: CheckButton = $CenterContainer/VBoxContainer/GridContainer/CheckButtonRightAiHard
